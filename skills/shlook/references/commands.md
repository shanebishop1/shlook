...
For a complete environment profile, including nonstandard explicit origins, run
`shlook connect --from-env --json`. The command verifies owner health and saves the profile without
